function [ labels, clipIndex, all_lowerDim ] = classifyClips_cascade_customFcn_pca(svmStruct, eigVectors, meanMatrix, clip_list, sampleLength, overlapLength,vectorFcn)
